...
import { X, Check, Crown, Rocket, Zap, ToggleLeft as SwitchIcon, Info } from 'lucide-react';
...
export default function MassMessageModal({ isOpen, leads, onClose, webhookUrl, userPlan, onUpgrade }: MassMessageModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
      <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center sticky top-0 bg-white dark:bg-gray-800 z-10">
          <h2 className="text-xl text-gray-900 dark:text-white">📤 Envio de Mensagens em Massa</h2>
          <button
            onClick={onClose}
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border-2 border-amber-300 dark:border-amber-700 rounded-xl p-6 shadow-lg">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-4 mb-4 border border-amber-200 dark:border-amber-800">
        ...
        <div className={`px-6 ${isFree ? 'py-4 opacity-50 pointer-events-none' : 'py-6'}`}>
          ...
          <div className="mb-6">
            ...
            {/* Lista de Leads */}
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg max-h-48 overflow-y-auto p-2 bg-white dark:bg-gray-800">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
          ...
          <div className="grid grid-cols-3 gap-4 bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg">
            <div className="text-center">
              ...
              <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">Leads Selecionados</div>
            </div>
            <div className="text-center">
              <div className="text-2xl text-green-600 dark:text-green-400">{stats.enviados}</div>
              <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">Enviados</div>
            </div>
            <div className="text-center">
              <div className="text-2xl text-red-600 dark:text-red-400">{stats.falhas}</div>
              <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">Falhas</div>
            </div>
          </div>
