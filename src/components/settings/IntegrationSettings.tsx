...
export default function IntegrationSettings({ user, onUpgrade }: IntegrationSettingsProps) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.success && data.webhookSettings) {
          ...
          // Save N8N webhook to localStorage for easy access in N8NMassMessageModal
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) {
        // Save N8N webhook to localStorage for easy access
        if (n8nMassWebhook) {
                ...
                <div className="flex-1">
                  ...
                  <div className="relative">
                    <Input
                      value={httpEndpoint || ''}
                      readOnly
                      className="pr-24 font-mono text-sm bg-white dark:bg-gray-800"
                    />
                    <Button
                      size="sm"
                      variant="outline"
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-3">
                    <Input
                      ...
                      className="w-full font-mono text-sm bg-white dark:bg-gray-800"
                    />
