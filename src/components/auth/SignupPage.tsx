    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 px-4">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-lg p-10 space-y-6 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-500">
                Welcome to LeadFlow CRM. Redirecting to dashboard...
              </p>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-10 space-y-6">
          ...
          <div className="space-y-2 pt-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-600">Free plan - No credit card required</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0" />
              <span className="text-sm text-gray-600">100 leads included</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0" />
              <span className="text-sm text-gray-600">Upgrade anytime</span>
            </div>
          </div>
