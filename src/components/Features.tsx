      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700 rounded-full mb-4">
            ...
            <span className="text-sm">Recursos Poderosos</span>
          </div>
          <h2 className="text-gray-900 mb-4">
            Tudo que você precisa para vender mais
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            LeadFlow CRM oferece ferramentas completas para captar, qualificar e
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative bg-gray-50 rounded-2xl p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 hover:border-blue-200"
              >
                {/* Icon */}
                <div
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600 mb-4">
            Explore todos os recursos gratuitamente por 14 dias
          </p>
          <a
            href="#planos"
