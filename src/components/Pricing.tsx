      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              return (
                <div
                  ...
                  className={`relative rounded-2xl p-8 transition-all duration-300 w-[320px] flex-shrink-0 ${
                    plan.highlighted
                      ? 'bg-gradient-to-br from-blue-600 to-purple-600 text-white shadow-2xl scale-105 border-2 border-blue-500'
                      : 'bg-gray-50 border border-gray-200 hover:shadow-xl hover:border-blue-200'
                  }`}
                >
                  {/* Popular Badge */}
                  {plan.popular && (
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600 mb-2">
            🎉 Comece grátis agora - <strong>Sem cartão de crédito</strong>
          </p>
